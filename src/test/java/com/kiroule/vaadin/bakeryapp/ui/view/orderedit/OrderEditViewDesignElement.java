...
@ServerClass("com.kiroule.vaadin.bakeryapp.ui.view.orderedit.OrderEditViewDesign")
@AutoGenerated
public class OrderEditViewDesignElement extends VerticalLayoutElement {
	...
	public OrderHistoryElement getHistory() {
		return $(com.kiroule.vaadin.bakeryapp.ui.view.orderedit.OrderHistoryElement.class).id("history");
	}
