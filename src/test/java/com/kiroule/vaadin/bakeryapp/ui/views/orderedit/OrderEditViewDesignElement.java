...
@ServerClass("com.kiroule.vaadin.bakeryapp.ui.views.orderedit.OrderEditViewDesign")
@AutoGenerated
public class OrderEditViewDesignElement extends VerticalLayoutElement {
	...
	public OrderHistoryElement getHistory() {
		return $(com.kiroule.vaadin.bakeryapp.ui.views.orderedit.OrderHistoryElement.class).id("history");
	}
